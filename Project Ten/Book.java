...
public class Book {
   ...
   * @return true iff the object is a Book which shares all attributes with this one, false
   *         otherwise
   */
  public boolean equals(Object o) {
    if (o == null)
      return false;
    // check if o is an instance of book
    if (o instanceof Book == false)
      return false;
    // cast other to a book
    Book b = (Book) o;
    // check the attributes
    if (b.getAuthor() == this.getAuthor() && b.getPageCount() == this.getPageCount()
